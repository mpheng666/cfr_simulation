...
namespace cfr_actuation_ns {
    ...
    void CfrActuation::resetTimerCb() { reset_flag_ = false; }
    ...
    {
        if (allow_move_) {
            double JoystickLeftX = joy_remapper_.joy_left_x_magnitude *
                                   msg->axes.at(joy_remapper_.joy_left_x_axis);
            double JoystickLeftY = joy_remapper_.joy_left_y_magnitude *
                                   msg->axes.at(joy_remapper_.joy_left_y_axis);
            double JoystickRightX = joy_remapper_.joy_right_x_magnitude *
                                    msg->axes.at(joy_remapper_.joy_right_x_axis);
            double JoystickRightY = joy_remapper_.joy_right_y_magnitude *
                                    msg->axes.at(joy_remapper_.joy_right_y_axis);
            ...
            this->joyToMotorActuation(JoystickLeftX, JoystickLeftY, JoystickRightX,
                                      JoystickRightY);
        }
            ...
            // system("notify-send -u low --hint int:transient:1 'CFR SIMULATION' 'Please
            // run the blades before moving!'");
            reset_flag_ = true;
    ...
    void CfrActuation::loadParams()
    {
        ...
        joy_remapper_.joy_left_x_magnitude =
        this->declare_parameter("joy_left_x_magnitude", 1.0);
        joy_remapper_.joy_left_y_magnitude =
        this->declare_parameter("joy_left_y_magnitude", 1.0);
        joy_remapper_.joy_right_x_magnitude =
        this->declare_parameter("joy_right_x_magnitude", 1.0);
        joy_remapper_.joy_right_y_magnitude =
                                           ...
                                           const double JoystickRightY)
    {
        ...
        motor_deg_limit_.LXmax * (JoystickRightY - joy_limit_.joymin) /
        (joy_limit_.joymax - joy_limit_.joymin);

        motor_actuation_.RXMotordeg_FB =
        -(motor_deg_limit_.RXmin * (1 - (JoystickRightY - joy_limit_.joymin) /
                                        (joy_limit_.joymax - joy_limit_.joymin)) +
          motor_deg_limit_.RXmax * (JoystickRightY - joy_limit_.joymin) /
          (joy_limit_.joymax - joy_limit_.joymin));

        motor_actuation_.LXMotordeg_ROT =
        -(motor_deg_limit_.LXmin * (1 - (JoystickRightX - joy_limit_.joymin) /
                                        (joy_limit_.joymax - joy_limit_.joymin)) +
          motor_deg_limit_.LXmax * (JoystickRightX - joy_limit_.joymin) /
          (joy_limit_.joymax - joy_limit_.joymin));

        motor_actuation_.RXMotordeg_ROT =
        -(motor_deg_limit_.RXmin * (1 - (JoystickRightX - joy_limit_.joymin) /
                                        (joy_limit_.joymax - joy_limit_.joymin)) +
          motor_deg_limit_.RXmax * (JoystickRightX - joy_limit_.joymin) /
          (joy_limit_.joymax - joy_limit_.joymin));

        motor_actuation_.LXMotordeg =
        motor_actuation_.LXMotordeg_FB + motor_actuation_.LXMotordeg_ROT;
        motor_actuation_.RXMotordeg =
        motor_actuation_.RXMotordeg_FB + motor_actuation_.RXMotordeg_ROT;

        motor_actuation_.RYMotordeg =
        motor_deg_limit_.RYmin * (1 - (JoystickLeftX - joy_limit_.joymin) /
                                      (joy_limit_.joymax - joy_limit_.joymin)) +
