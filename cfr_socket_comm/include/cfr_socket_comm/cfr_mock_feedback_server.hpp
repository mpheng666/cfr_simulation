#ifndef CFR_SOCKET_COMM_MOCK_FEEDBACK_SERVER_HPP_
#define CFR_SOCKET_COMM_MOCK_FEEDBACK_SERVER_HPP_
...
namespace cfr_socket_comm {
    ...
    class CfrMockFeedbackServer {
    public:
        CfrMockFeedbackServer(int port);
        void run();
