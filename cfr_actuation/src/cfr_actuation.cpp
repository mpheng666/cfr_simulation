...
namespace cfr_actuation_ns
{
    ...
    Node("cfr_actuation"),
    axes_pub_(this->create_publisher<Floats>("cfr_axes", 10)),
    joy_sub_(this->create_subscription<Joy>("joy", 10, std::bind(&CfrActuation::joyCb, this, _1))),
    ...
    {
        // auto axes_msg = std_msgs::msg::Float64MultiArray();
    }

    void CfrActuation::joyCb(const Joy::SharedPtr msg)
    {
